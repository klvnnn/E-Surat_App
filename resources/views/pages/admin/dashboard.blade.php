                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-12 col-xl-auto mt-4">
                            <div class="input-group input-group-joined border-0" style="width: 16.5rem">
                                <span class="input-group-text"><i class="text-red" data-feather="calendar"></i></span>
                    ...
                    <div class="card h-100">
                        <div class="card-body h-100">
                            <div class="row align-items-center">
                                <img src="{{ asset('admin/assets/img/illustrations/waves.svg') }}" alt="">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                        <h1 class="text-red">Selamat Datang Di</h1>
                                        <p class="text-gray-700 mb-0">Website Aplikasi Pengarsipan Surat Digital E-Surat KKSP</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-xxl-12 text-center">
                                    <img class="img-fluid me-5"
                                        src="{{ asset('admin/assets/img/illustrations/dashboard2.svg') }}" width=""
                                        style="max-width: 15rem" />
                                    <img class="img-fluid"
                                        src="{{ asset('admin/assets/img/illustrations/logo_kksp_surat.png') }}" width=""
                                        style="max-width: 10rem" />
                                    <img class="img-fluid ms-5"
                                        src="{{ asset('admin/assets/img/illustrations/dashboard3.svg') }}" width=""
                                        style="max-width: 15rem" />
                                    </div>
                            </div>
                        </div>
