                            ...
                            <form action="{{ route('update.password') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('new_password') is-invalid @enderror"
                                        name="new_password" type="password" id="password" required />
                                    @error('new_password')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('new_confirm_password') is-invalid @enderror"
                                        name="new_confirm_password" type="password" id="passwordd" required />
                                ...
                                <input type="checkbox" onclick="myFunction(), myFunction2()" class="mt-2"> <label class="small mb-1" for="checkbox">Show Password</label>
                                    <script>
                                        function myFunction() {
